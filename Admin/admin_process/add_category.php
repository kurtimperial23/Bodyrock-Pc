...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $query = "INSERT INTO tbl_categories (categoryName) VALUES ('$categoryName')";
    $result = mysqli_query($connection, $query);

    if ($result) {
        // Category added successfully, redirect to category.php or show a success message
        header("Location: /bodyrockpc/admin/category.php");
        exit();
    } else {
        // Error adding category, handle accordingly (redirect, show error message, etc.)
    ...
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                ...
                <li>
                    <a href="/bodyrockpc/admin/category.php" class="active"><span class="las la-history"></span>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="container">
                ...
                <main>
                    <!-- Add your form for adding a category here -->
                    <form method="post" action="/bodyrockpc/admin/admin_process/add_category.php">
