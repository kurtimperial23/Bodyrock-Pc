...
<body>
    <div class="sidebar">
        ...
        <div class="sidebar-menu">
            <ul>
                <li>
                    <a href="/bodyrockpc/admin/admin_dashboard.php" class="active"><span
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <div class="row d-flex justify-content-center">
                <div class="col-3 appointments text-center pt-2">
                    <h5>Items:
                    </h5>
                </div>
                <div class="col-3 appointments text-center pt-2">
            ...
            <div class="container">
            <a class="btn btn-primary btn-lg" href="/bodyrockpc/admin/admin_process/add_category.php">Add Category</a>
            <a class="btn btn-primary btn-lg" href="/bodyrockpc/admin/admin_process/add_items.php">Add Items</a>
            <a class="btn btn-primary btn-lg" href="/bodyrockpc/admin/admin_process/add_supplier.php">Add Supplier</a>
                <br><br>
            </div>
        </main>
